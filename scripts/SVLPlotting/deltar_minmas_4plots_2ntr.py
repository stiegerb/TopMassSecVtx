...
for i in range(0,6):
	...
	for x in range(0,len(listoffiles[i])):
		...
		histo_correct.append(rootfile1[x].Get("mlSv_emu_deltar_ntr2_correct"))
		histo_wrong.append(rootfile1[x].Get("mlSv_emu_deltar_ntr2_wrong"))

		#min mass
		histo_correctmass.append(rootfile1[x].Get("mlSv_emu_minmass_ntr2_correct"))
		histo_wrongmass.append(rootfile1[x].Get("mlSv_emu_minmass_ntr2_wrong"))
...
c.SaveAs("./../plots/deltar_minmass_4plots_2ntr.pdf")
c11.SaveAs("./../plots/deltar_correct_2ntr.pdf")
c12.SaveAs("./../plots/deltar_wrong_2ntr.pdf")
c13.SaveAs("./../plots/deltar_correctmass_2ntr.pdf")
c14.SaveAs("./../plots/deltar_wrongmass_2ntr.pdf")
...
c2.cd()
graph1.Draw("AP")
graph1.GetYaxis().SetRangeUser(44.,52.)
...
# Save the plot and close the files
c2.SaveAs("./../plots/deltar_minmass_2plots_2ntr.pdf")
...
# Save the plot and close the files
c3.SaveAs("./../plots/deltar_minmass_4plots_divided_2ntr.pdf")
c21.SaveAs("./../plots/deltar_correct_divided_2ntr.pdf")
c22.SaveAs("./../plots/deltar_wrong_divided_2ntr.pdf")
c23.SaveAs("./../plots/deltar_correctmass_divided_2ntr.pdf")
c24.SaveAs("./../plots/deltar_wrongmass_divided_2ntr.pdf")
