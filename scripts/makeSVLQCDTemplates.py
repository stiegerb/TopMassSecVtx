...
SELECTIONS = [
	('e',            'abs(EvCat)==11', 'e'),
	('m',            'abs(EvCat)==13', '#mu'),
	('etoppt',       'Weight[10]*(abs(EvCat)==11)', 'e'),
	('mtoppt',       'Weight[10]*(abs(EvCat)==13)', '#mu'),
	...
	('etoppt_mrankinc',    'Weight[10]*(SVLMassRank==1&&abs(EvCat)==11)', 'e'),
	('mtoppt_mrankinc',    'Weight[10]*(SVLMassRank==1&&abs(EvCat)==13)', '#mu'),
	('e_mrankinc_qcd',
	 '(SVLMassRank==1&&abs(EvCat)==1100)',
	 'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	('m_mrankinc_qcd',
	 '(SVLMassRank==1&&abs(EvCat)==1300)',
	 'non-isolated #mu, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	('etoppt_mrankinc_qcd',
	 'Weight[10]*(SVLMassRank==1&&abs(EvCat)==1100)',
	 'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	('mtoppt_mrankinc_qcd',
	 'Weight[10]*(SVLMassRank==1&&abs(EvCat)==1300)',
	 'non-isolated #mu, N_{jets}#geq 4, N_{b-tags} #leq 1'),

	('e_mrank',         'SVLMassRank==1&&SVLDeltaR<2.0&&abs(EvCat)==11', 'e'),
	('m_mrank',         'SVLMassRank==1&&SVLDeltaR<2.0&&abs(EvCat)==13', '#mu'),
	('etoppt_mrank',    'Weight[10]*(SVLMassRank==1&&SVLDeltaR<2.0&&abs(EvCat)==11)', 'e'),
	('mtoppt_mrank',    'Weight[10]*(SVLMassRank==1&&SVLDeltaR<2.0&&abs(EvCat)==13)', '#mu'),
	('e_mrank_qcd',
	 '(SVLMassRank==1&&SVLDeltaR<2.0&&abs(EvCat)==1100)',
	 'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	('m_mrank_qcd',
	 '(SVLMassRank==1&&SVLDeltaR<2.0&&abs(EvCat)==1300)',
	 'non-isolated #mu, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	('etoppt_mrank_qcd',
	 'Weight[10]*(SVLMassRank==1&&SVLDeltaR<2.0&&abs(EvCat)==1100)',
	 'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	('mtoppt_mrank_qcd',
	 'Weight[10]*(SVLMassRank==1&&SVLDeltaR<2.0&&abs(EvCat)==1300)',
	 'non-isolated #mu, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	...
	('etoppt_drrankinc',    'Weight[10]*(SVLDeltaRRank==1&&abs(EvCat)==11)', 'e'),
	('mtoppt_drrankinc',    'Weight[10]*(SVLDeltaRRank==1&&abs(EvCat)==13)', '#mu'),
	('e_drrankinc_qcd',
	 '(SVLDeltaRRank==1&&abs(EvCat)==1100)',
	 'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	('m_drrankinc_qcd',
	 '(SVLDeltaRRank==1&&abs(EvCat)==1300)',
	 'non-isolated #mu, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	('etoppt_drrankinc_qcd',
	 'Weight[10]*(SVLDeltaRRank==1&&abs(EvCat)==1100)',
	 'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	('mtoppt_drrankinc_qcd',
	 'Weight[10]*(SVLDeltaRRank==1&&abs(EvCat)==1300)',
	 'non-isolated #mu, N_{jets}#geq 4, N_{b-tags} #leq 1'),

	('e_drrank',         'SVLDeltaRRank==1&&SVLDeltaR<2.0&&abs(EvCat)==11', 'e'),
	('m_drrank',         'SVLDeltaRRank==1&&SVLDeltaR<2.0&&abs(EvCat)==13', '#mu'),
	('etoppt_drrank',    'Weight[10]*(SVLDeltaRRank==1&&SVLDeltaR<2.0&&abs(EvCat)==11)', 'e'),
	('mtoppt_drrank',    'Weight[10]*(SVLDeltaRRank==1&&SVLDeltaR<2.0&&abs(EvCat)==13)', '#mu'),
	('e_drrank_qcd',
	 '(SVLDeltaRRank==1&&SVLDeltaR<2.0&&abs(EvCat)==1100)',
	 'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	('m_drrank_qcd',
	 '(SVLDeltaRRank==1&&SVLDeltaR<2.0&&abs(EvCat)==1300)',
	 'non-isolated #mu, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	('etoppt_drrank_qcd',
	 'Weight[10]*(SVLDeltaRRank==1&&SVLDeltaR<2.0&&abs(EvCat)==1100)',
	 'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	('mtoppt_drrank_qcd',
	 'Weight[10]*(SVLDeltaRRank==1&&SVLDeltaR<2.0&&abs(EvCat)==1300)',
	 'non-isolated #mu, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	...
	('etoppt_drrank1',    'Weight[10]*(SVLDeltaRRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==11)', 'e'),
	('mtoppt_drrank1',    'Weight[10]*(SVLDeltaRRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==13)', '#mu'),
	('e_drrank1_qcd',
	 '(SVLDeltaRRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==1100)',
	 'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	('m_drrank1_qcd',
	 '(SVLDeltaRRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==1300)',
	 'non-isolated #mu, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	('etoppt_drrank1_qcd',
	 'Weight[10]*(SVLDeltaRRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==1100)',
	 'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	('mtoppt_drrank1_qcd',
	 'Weight[10]*(SVLDeltaRRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==1300)',
	 'non-isolated #mu, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	...
	('etoppt_optmrank_qcd',
	 ...
	 'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	('mtoppt_optmrank_qcd',
	 'Weight[10]*(SVLCombRank>0&&abs(EvCat)==1300)',
	 'non-isolated #mu, N_{jets}#geq 4, N_{b-tags} #leq 1')
]
