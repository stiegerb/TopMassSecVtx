...
DataAnalyzer::DataAnalyzer(const edm::ParameterSet &iConfig) : obsPU_h(0), truePU_h(0)
{
    ...
    eIsolator03_.initializeElectronIsolation(true);
    eIsolator03_.setConeSize(0.3);
    eIsolator04_.initializeElectronIsolation(true);
    eIsolator04_.setConeSize(0.4);
    gIsolator03_.initializePhotonIsolation(true);
    gIsolator03_.setConeSize(0.3);
    gIsolator04_.initializePhotonIsolation(true);
    gIsolator04_.setConeSize(0.4);
        ...
        try {
            ...
            for(size_t iid=0; iid<4; iid++)
            {
                ...
                bool hasId=EgammaCutBasedEleId::PassWP( EgammaCutBasedEleId::WorkingPoint(id), ele->isEB(), ele->pt(), ele->eta(),
                                                        ...
                                                        0., 0., 0., ev.egn_isConv[ev.egn], ev.ln_trkLostInnerHits[ev.ln], *rho,ElectronEffectiveArea::kEleEAData2012);
