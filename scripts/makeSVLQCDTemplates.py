...
SELECTIONS = [
	...
	# ('etoppt_mrank1',    'Weight[10]*(SVLMassRank==1&&CombCat%2!=0&&abs(EvCat)==11 && NJets>=4)', 'e'),
	# ('mtoppt_mrank1',    'Weight[10]*(SVLMassRank==1&&CombCat%2!=0&&abs(EvCat)==13 && NJets>=4)', '#mu'),
	# ('e_mrank1_qcd',
	#  '(SVLMassRank==1&&CombCat%2!=0&&abs(EvCat)==1100 && NJets>=4)',
	#  'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	# ('m_mrank1_qcd',
	#  '(SVLMassRank==1&&CombCat%2!=0&&abs(EvCat)==1300 && NJets>=4)',
	#  'non-isolated #mu, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	# ('etoppt_mrank1_qcd',
	#  'Weight[10]*(SVLMassRank==1&&CombCat%2!=0&&abs(EvCat)==1100 && NJets>=4)',
	#  'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	# ('mtoppt_mrank1_qcd',
	#  'Weight[10]*(SVLMassRank==1&&CombCat%2!=0&&abs(EvCat)==1300 && NJets>=4)',
	#  'non-isolated #mu, N_{jets}#geq 4, N_{b-tags} #leq 1'),

	# ('e_mrank1dr',         'SVLMassRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==11 && NJets>=4', 'e'),
	# ('m_mrank1dr',         'SVLMassRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==13 && NJets>=4', '#mu'),
	# ('etoppt_mrank1dr',    'Weight[10]*(SVLMassRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==11 && NJets>=4)', 'e'),
	# ('mtoppt_mrank1dr',    'Weight[10]*(SVLMassRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==13 && NJets>=4)', '#mu'),
	# ('e_mrank1dr_qcd',
	#  '(SVLMassRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==1100 && NJets>=4)',
	#  'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	# ('m_mrank1dr_qcd',
	#  '(SVLMassRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==1300 && NJets>=4)',
	#  'non-isolated #mu, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	# ('etoppt_mrank1dr_qcd',
	#  'Weight[10]*(SVLMassRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==1100 && NJets>=4)',
	#  'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	# ('mtoppt_mrank1dr_qcd',
	#  'Weight[10]*(SVLMassRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==1300 && NJets>=4)',
	#  'non-isolated #mu, N_{jets}#geq 4, N_{b-tags} #leq 1'),

	# ('e_drrank1dr',         'SVLDeltaRRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==11 && NJets>=4', 'e'),
	# ('m_drrank1dr',         'SVLDeltaRRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==13 && NJets>=4', '#mu'),
	# ('etoppt_drrank1dr',    'Weight[10]*(SVLDeltaRRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==11 && NJets>=4)', 'e'),
	# ('mtoppt_drrank1dr',    'Weight[10]*(SVLDeltaRRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==13 && NJets>=4)', '#mu'),
	# ('e_drrank1dr_qcd',
	#  '(SVLDeltaRRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==1100 && NJets>=4)',
	#  'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	# ('m_drrank1dr_qcd',
	#  '(SVLDeltaRRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==1300 && NJets>=4)',
	#  'non-isolated #mu, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	# ('etoppt_drrank1dr_qcd',
	#  'Weight[10]*(SVLDeltaRRank==1&&SVLDeltaR<2.0&&CombCat%2!=0&&abs(EvCat)==1100 && NJets>=4)',
	#  'non-isolated e, N_{jets}#geq 4, N_{b-tags} #leq 1'),
	# ('mtoppt_drrank1dr_qcd',
