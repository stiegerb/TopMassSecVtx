...
bool DataEventSummaryHandler::init(TTree *t, bool needsToRecreate)
{
    ...
    t_->Branch("mc_genNeutrino",  evSummary_.mc_genNeutrino,    "mc_genNeutrino[mcn]/O");
...
data::PhysicsObjectCollection_t DataEventSummaryHandler::getPhysicsObject(int code)
{
    ...
    case LEPTONS:
        for(Int_t ilep=0; ilep<evSummary_.ln; ilep++)
        {
            ...
            lep.setVal("gIso03",              evSummary_.ln_gIso03[ilep]);
            lep.setVal("chIso03",             evSummary_.ln_chIso03[ilep]);
            lep.setVal("puchIso03",           evSummary_.ln_puchIso03[ilep]);
            lep.setVal("nhIso03",             evSummary_.ln_nhIso03[ilep]);
            lep.setVal("gIso04",              evSummary_.ln_gIso04[ilep]);
            lep.setVal("chIso04",             evSummary_.ln_chIso04[ilep]);
            lep.setVal("puchIso04",           evSummary_.ln_puchIso04[ilep]);
            lep.setVal("nhIso04",             evSummary_.ln_nhIso04[ilep]);
            lep.setVal("ecalIso03",           evSummary_.ln_ecalIso03[ilep]);
            lep.setVal("trk03",               evSummary_.ln_trkIso03[ilep]);
            lep.setVal("hcalIso03",           evSummary_.ln_hcalIso03[ilep]);
            lep.setVal("ecalIso04",           evSummary_.ln_ecalIso04[ilep]);
            lep.setVal("trk04",               evSummary_.ln_trkIso04[ilep]);
            lep.setVal("hcalIso04",           evSummary_.ln_hcalIso04[ilep]);
    ...
    case PHOTONS:
        for(Int_t ig=0; ig<evSummary_.gn; ig++)
        {
            ...
            photon.setVal("gIso03",    evSummary_.gn_gIso03[ig]);
            photon.setVal("chIso03",   evSummary_.gn_chIso03[ig]);
            photon.setVal("puchIso03", evSummary_.gn_puchIso03[ig]);
            photon.setVal("nhIso03",   evSummary_.gn_nhIso03[ig]);
            photon.setVal("gIso04",    evSummary_.gn_gIso04[ig]);
            photon.setVal("chIso04",   evSummary_.gn_chIso04[ig]);
            photon.setVal("puchIso04", evSummary_.gn_puchIso04[ig]);
            photon.setVal("nhIso04",   evSummary_.gn_nhIso04[ig]);
            photon.setVal("ecalIso03", evSummary_.gn_ecalIso03[ig]);
            photon.setVal("trk03",     evSummary_.gn_trkIso03[ig]);
            photon.setVal("hcalIso03", evSummary_.gn_hcalIso03[ig]);
            photon.setVal("ecalIso04", evSummary_.gn_ecalIso04[ig]);
            photon.setVal("trk04",     evSummary_.gn_trkIso04[ig]);
            photon.setVal("hcalIso04", evSummary_.gn_hcalIso04[ig]);
...
std::vector<float> utils::cmssw::pullDeltaTheta(data::PhysicsObject_t &jet1, data::PhysicsObject_t &jet2, data::PhysicsObjectCollection_t &pf)
{
    ...
    if(jet1.objs.find("t_all")==jet1.objs.end() || jet2.objs.find("t_all")==jet2.objs.end()) {
        pullSummary.clear();
        return pullSummary;
    }
...
std::vector<LorentzVector> utils::cmssw::getMETvariations(data::PhysicsObject_t &rawMETP4, data::PhysicsObjectCollection_t &jets, data::PhysicsObjectCollection_t &leptons,bool isMC)
{
    ...
    for(size_t ivar=1; ivar<=8; ivar++)
    {
        ...
        for(size_t ijet=0; ijet<jets.size(); ijet++)
        {
            ...
            LorentzVector newJet( jets[ijet] );
            newJet *= jetsf;
