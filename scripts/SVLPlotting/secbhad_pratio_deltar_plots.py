...
for i in range(0,6):
	...
	if i==4:
		print ts_pratio_2ntr[4].Integral()
...
ts_deltar_2ntr_allmases = TH1D("secbhad_deltar_emu_2ntr_allmases", "deltaR between secvtx and bhadron in emu channel, ", 100, 0., 0.4)
ts_deltar_3ntr_allmases = TH1D("secbhad_deltar_emu_3ntr_allmases", "deltaR between secvtx and bhadron in emu channel, ", 100, 0., 0.4)
ts_deltar_4ntr_allmases = TH1D("secbhad_deltar_emu_4ntr_allmases", "deltaR between secvtx and bhadron in emu channel, ", 100, 0., 0.4)
ts_deltar_5ntr_allmases = TH1D("secbhad_deltar_emu_5ntr_allmases", "deltaR between secvtx and bhadron in emu channel, ", 100, 0., 0.4)
ts_deltar_6ntr_allmases = TH1D("secbhad_deltar_emu_6ntr_allmases", "deltaR between secvtx and bhadron in emu channel, ", 100, 0., 0.4)
ts_deltar_7ntr_allmases = TH1D("secbhad_deltar_emu_7ntr_allmases", "deltaR between secvtx and bhadron in emu channel, ", 100, 0., 0.4)
ts_deltar_8ntr_allmases = TH1D("secbhad_deltar_emu_8ntr_allmases", "deltaR between secvtx and bhadron in emu channel, ", 100, 0., 0.4)
ts_deltar_9ntr_allmases = TH1D("secbhad_deltar_emu_9ntr_allmases", "deltaR between secvtx and bhadron in emu channel, ", 100, 0., 0.4)
ts_deltar_10ntr_allmases = TH1D("secbhad_deltar_emu_10ntr_allmases", "deltaR between secvtx and bhadron in emu channel, ", 100, 0., 0.4)
...
graph_pratio_allmases.SetTitle("Average ratio between p of secvtx and bhadron (all mases together)")
...
graph_deltar_allmases.SetTitle("DeltaR between secvtx and bhadron (all mases together)")
