...
for i in range(0,6):
	...
	for x in range(0,len(listoffiles[i])):
		...
		histo_correct.append(rootfile1[x].Get("mlSv_emu_deltar_ntr3_correct"))
		histo_wrong.append(rootfile1[x].Get("mlSv_emu_deltar_ntr3_wrong"))

		#min mass
		histo_correctmass.append(rootfile1[x].Get("mlSv_emu_minmass_ntr3_correct"))
		histo_wrongmass.append(rootfile1[x].Get("mlSv_emu_minmass_ntr3_wrong"))
...
c.SaveAs("./../plots/deltar_minmass_4plots_3ntr.pdf")
c11.SaveAs("./../plots/deltar_correct_3ntr.pdf")
c12.SaveAs("./../plots/deltar_wrong_3ntr.pdf")
c13.SaveAs("./../plots/deltar_correctmass_3ntr.pdf")
c14.SaveAs("./../plots/deltar_wrongmass_3ntr.pdf")
...
c2.cd()
graph1.Draw("AP")
graph1.GetYaxis().SetRangeUser(52.,60.)
...
# Save the plot and close the files
c2.SaveAs("./../plots/deltar_minmass_2plots_3ntr.pdf")
...
# Save the plot and close the files
c3.SaveAs("./../plots/deltar_minmass_4plots_divided_3ntr.pdf")
c21.SaveAs("./../plots/deltar_correct_divided_3ntr.pdf")
c22.SaveAs("./../plots/deltar_wrong_divided_3ntr.pdf")
c23.SaveAs("./../plots/deltar_correctmass_divided_3ntr.pdf")
c24.SaveAs("./../plots/deltar_wrongmass_divided_3ntr.pdf")
